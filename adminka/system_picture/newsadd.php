<?php
  ...
  try
  {
	...
	$urlpict=new field_file("urlpict", "Изображения", false, $_FILES, "../../media/images/");
	...
	if(!$error)
	{
		...
		$picturesmall="";
			...
			$query="INSERT INTO $tbl_photos VALUES (NULL, '{$form->fields['name']->value}', '{$form->fields['editor1']->value}','$picture','$picturesmall','show','NOW()')";
